...
import com.architectica.socialcomponents.adapters.HashtagProjectsAdapter;
...
public class HashtagProjectsActivity extends BaseActivity<HashtagView,HashtagPresenter> implements HashtagView {

    private HashtagProjectsAdapter postsAdapter;
    ...
    private void initPostListRecyclerView() {
        ...
        postsAdapter = new HashtagProjectsAdapter(hashtag,this,swipeContainer);
    ...
    public void openPostDetailsActivity(Post post, View v) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (imageView.getVisibility() != View.GONE){
                ...
                startActivityForResult(intent, ProjectDetailsActivity.UPDATE_PROJECT_REQUEST , options.toBundle());
