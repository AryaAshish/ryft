...
public class RewardsImageViewHolder extends RecyclerView.ViewHolder {
    ...
    public RewardsImageViewHolder(View view, final OnClickListener onClickListener, BaseActivity activity) {
        this(view, onClickListener, activity, true);
    }

    public RewardsImageViewHolder(View view, final OnClickListener onClickListener, BaseActivity activity, boolean isAuthorNeeded) {
        super(view);
