...
public class ProjectsImageViewHolder extends RecyclerView.ViewHolder {
    ...
    public ProjectsImageViewHolder(View view, final OnClickListener onClickListener, BaseActivity activity) {
        this(view, onClickListener, activity, true);
    }

    public ProjectsImageViewHolder(View view, final OnClickListener onClickListener, BaseActivity activity, boolean isAuthorNeeded) {
        super(view);
