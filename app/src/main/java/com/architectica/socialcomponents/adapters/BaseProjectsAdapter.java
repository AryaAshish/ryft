...
public abstract class BaseProjectsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BaseProjectsAdapter(BaseActivity activity) {
    ...
    public int getItemViewType(int position) {
        ...
        //Log.i("debugging","" + postList.get(position).getId() + postList.get(position).getTitle());
    ...
    public void updateSelectedPost() {
        if (selectedPostPosition != RecyclerView.NO_POSITION) {
            ...
            PostInteractor.getInstance(activity).getSingleProject(selectedPost.getId(), createOnPostChangeListener(selectedPostPosition));
        }
    }
