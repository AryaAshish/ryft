...
public class PostVideoViewHolder extends RecyclerView.ViewHolder implements ToroPlayer,ToroPlayer.EventListener {
    ...
    public PostVideoViewHolder(View view, final OnClickListener onClickListener, BaseActivity activity) {
        this(view, onClickListener, activity, true);
    }

    public PostVideoViewHolder(View view, final OnClickListener onClickListener, BaseActivity activity, boolean isAuthorNeeded) {
        super(view);
    ...
    public void bindData(Post post) {
        ...
        //Log.i("imagetitle",post.getImageTitle());

        if (post.getImageTitle() != null && !post.getImageTitle().isEmpty()){
