...
public class HashtagProjectsAdapter extends BasePostsAdapter{
    ...
    private HashtagProjectsActivity mainActivity;
    private String hashtag;

    public HashtagProjectsAdapter(String hashtag,final HashtagProjectsActivity activity, SwipeRefreshLayout swipeContainer) {
        super(activity);
    ...
    private void loadHashtagNextPage(final long nextItemCreatedDate) {
        ...
        PostInteractor.getInstance(activity).getHashtagProjectList(hashtag,onPostsDataChangedListener, nextItemCreatedDate);
